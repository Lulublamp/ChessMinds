...
const FriendCard: React.FC<FriendCardProps> = ({ idJoueur, defiMode, handleDefiClick }) => {
  ...
  const deleteFriend = async () => {
    ...
    try{
      await axios.post(`${API_BASE_URL}/joueurs/friends/remove/`, {friendId : idJoueur },{
        headers: {
  ...
  if (!playerDetails || isDeleted) return null;
  ...
  return (
    <div>
      ...
      <svg onClick={deleteFriend} width="35" height="35" viewBox="0 0 35 35" fill="none">
