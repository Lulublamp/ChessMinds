...
const PopupModifProfil: React.FC<Props> = ({togglePopup}) => {
  ...
  return (
    <div className="PopupModifProfil">
      ...
      <div>
        ...
        {!isIconChoicesOpen && <ProfileSettings onIconClick={openIconChoices} />}
        {isIconChoicesOpen && <ProfileIconChoices onIconClick={closeIconChoices} />}
